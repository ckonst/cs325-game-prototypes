...
GameStates.makePreloader = function (game) {
    ...
    return {
        preload: function () {
            ...
            game.load.atlas(
                'playButton',
                'assets/img/play_button3.png',
                'assets/img/play_button3.json',
            );
            ...
            game.load.audio(
                'excellent1',
                'assets/audio/excellent/excellent1.ogg',
            );
            game.load.audio(
                'excellent2',
                'assets/audio/excellent/excellent2.ogg',
            );
            game.load.audio(
                'excellent3',
                'assets/audio/excellent/excellent3.ogg',
            );
